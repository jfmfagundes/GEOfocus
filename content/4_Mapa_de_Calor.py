...
import time  # Para simulação de tempo de carregamento
...
# Verifica se a sessão já tem a flag de "mostrar mensagem"
if 'show_info' not in st.session_state:
    st.session_state.show_info = True  # Definir a flag inicial como True

# Exibe a mensagem informativa apenas se 'show_info' for True
if st.session_state.show_info:
    # Mostra uma mensagem com a opção de fechar
    with st.expander("Aviso", expanded=True):
        ...
        if st.button("Fechar Aviso"):
            st.session_state.show_info = False  # Atualiza o estado para esconder a mensagem após o clique

# Exibe o mapa apenas se o aviso foi fechado
